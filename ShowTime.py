...
st.write('<style>div.block-container.css-128j0gw.egzxvld2{padding-top:0rem;}</style>', unsafe_allow_html=True)

st.markdown(
    """
    <h1 style="text-align: center; font-size: 70px"><i>SHOWTIME</i></h1>
    <style>
    h1 {
